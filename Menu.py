...
fundo = GameImage("assets/sprites/fundo.png")

keyboard = Window.get_keyboard()
mouse = Window.get_mouse()

musica = Sound("assets/sounds/tema.ogg")
musica.set_volume(80)
musica.play()

while True:
    play = Sprite("assets/sprites/play.png")
    play.x = janela.width/2 - play.width/2
    play.y = 220

    ajuda = Sprite("assets/sprites/help.png")
    ajuda.x = janela.width/2 - ajuda.width/2
    ajuda.y = 220 + play.height + 20

    rank = Sprite("assets/sprites/rank.png")
    ...
    if mouse.is_over_area([play.x, play.y], [play.x+play.width, play.y+play.height]):
        play = Sprite("assets/sprites/play2.png")
        play.x = janela.width/2 - play.width/2
        play.y = 220
